	...
	<div id="content">
		<div class="s_wrap">
						...
						<tbody>
							<tr>
								...
								<td colspan="3">
									...
									name="keyword" value="" class="frm_input" size="100">
								</td>
							</tr>
							<!--   <tr>
                                    <th scope="row">작성일</th>
			...
			<div class="local_ov mart30">
				총 공고 수 : <b class="fc_red">${postingCount}</b>개 <a
					href="/admin/jobposting" class="fr btn_lsmall green">신규공고 등록</a>
						...
						<tr class="list0">
							...
							<c:forEach var="jobpostingItem" items="${jobpostingList}">
								...
								<tr class="list0">
									...
									<td><a
										href="/admin/modifyJobposting?postingId=${jobpostingItem.postingId}">${jobpostingItem.title}</a></td>
									<td>${jobpostingItem.employmentType}</td>
									<td>${jobpostingItem.postWrittenDate}</td>
									<td>${jobpostingItem.postStatus}</td>
									<td><a
										href="/admin/modifyJobposting?postingId=${jobpostingItem.postingId}"
